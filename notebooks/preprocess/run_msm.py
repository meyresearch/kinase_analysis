...
ftraj_dir = Path('/exports/eddie/scratch/s2135271/data_abl/ftrajs')
study_name = 'markov_lag'
save_dir = Path(f'/exports/csce/eddie/chem/groups/Mey/Ryan/kinase_analysis/data_abl/msm/{study_name}')
