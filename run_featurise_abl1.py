...
if __name__ == "__main__":
    ...
    featurisers = [dbdist_featuriser, dbdihed_featuriser, aloop_featuriser, achelix_featuriser, aloopdssp_featuriser, achelixdssp_featuriser, achelixdihed_featuriser]
